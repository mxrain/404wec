...
export const config = {
  ...
  apiBaseUrl: `https://raw.gitmirror.com/${process.env.NEXT_PUBLIC_GITHUB_OWNER || 'mxrain'}/${process.env.NEXT_PUBLIC_GITHUB_REPO || '404zyt'}/refs/heads/master/src/db/zyt`,
